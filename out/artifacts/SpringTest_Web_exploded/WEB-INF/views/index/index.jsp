    ...
    <div class="nav fl">
        <ul>
            <c:forEach items="${classifyList}" var="clist">
                <li><a href="/shop/index/${clist.id}">${clist.name}</a></li>
            </c:forEach>
        </ul>
    </div>
    <div class="search fr">
...
<div class="banner_y center">
    <div class="nav">
        <ul>
            <c:forEach items="${classifyList}" var="cflist">
            <li>
                <a href="">${cflist.name}</a>
                <div class="pop">
                    <c:forEach items="${cflist.shopsList}" var="splist">
                    <div class="ctn fl" style="height: 71px;">
                        <div>
                            <div class="xuangou_left fl">
                                <a href="">
                                    <div class="img fl"><img src="/image/${splist.image}" style="width: 40px;height: 40px;"></div>
                                    <span class="fl">${splist.name}</span>
                                    <div class="clear"></div>
                                </a>
                            </div>
